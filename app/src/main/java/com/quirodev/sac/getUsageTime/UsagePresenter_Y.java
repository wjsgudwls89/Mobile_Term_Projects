...
public class UsagePresenter_Y implements UsageContract.Presenter {
    ...
    public UsagePresenter_Y(Context context, UsageContract.View view) {
    ...
    public void retrieveUsageStats() {
        ...
        List<UsageStats> mystats = usageStatsManager.queryUsageStats(UsageStatsManager.INTERVAL_YEARLY, getStartTime(),System.currentTimeMillis());
