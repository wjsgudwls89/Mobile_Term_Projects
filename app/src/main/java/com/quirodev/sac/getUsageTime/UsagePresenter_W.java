...
public class UsagePresenter_W implements UsageContract.Presenter {
    ...
    public UsagePresenter_W(Context context, UsageContract.View view) {
    ...
    public void retrieveUsageStats() {
        ...
        List<UsageStats> mystats = usageStatsManager.queryUsageStats(UsageStatsManager.INTERVAL_WEEKLY, getStartTime(),System.currentTimeMillis());
